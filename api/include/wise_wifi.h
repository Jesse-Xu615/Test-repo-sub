...
/**
  ...
  *    - WISE_ERR_INVALID_ARG: invalid argument
  */
wise_err_t wise_wifi_set_channel(uint8_t primary, wifi_second_chan_t second);
...
/**
  ...
  *    - WISE_ERR_INVALID_ARG: invalid argument
  */
wise_err_t wise_wifi_get_channel(uint8_t *primary, wifi_second_chan_t *second);
...
/**
  ...
  *    - WISE_ERR_WIFI_NOT_INIT: WiFi is not initialized by wise_wifi_init
  */
wise_err_t wise_wifi_set_promiscuous_rx_cb(wifi_promiscuous_cb_t cb);
...
/**
  ...
  *    - WISE_ERR_WIFI_NOT_INIT: WiFi is not initialized by wise_wifi_init
  */
wise_err_t wise_wifi_set_promiscuous(bool en);
...
/**
  ...
  *    - WISE_ERR_INVALID_ARG: invalid argument
  */
wise_err_t wise_wifi_get_promiscuous(bool *en);

...
int scm_wifi_add_filter(char *filter, wifi_filter_type type);
int scm_wifi_del_filter(char *filter, wifi_filter_type type);
int scm_wifi_query_filter(char **filter, int *num, wifi_filter_type type);
int scm_wifi_set_default_filter(wifi_packet_filter direction);
int scm_vlwip_netif_reset(wifi_filter_type type);
